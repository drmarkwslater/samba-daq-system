...
ARCHIVE_VAR char  Organisation[MAXFILENAME];
...
ARCHIVE_VAR char  SettingsCoupures,SettingsConformite;
...
ARCHIVE_VAR char TopDir[MAXFILENAME];
...
ARCHIVE_VAR ArgDesc TangoDesc[]
 ...
 = {
	...
	{ "RC_ms",       DESC_FLOAT                &TangoRCdefaut,    "Temps de descente par defaut de l'ampli" },
