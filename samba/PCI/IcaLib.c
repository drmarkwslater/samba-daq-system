...
#else  /* !BITS64 */
	kern_return_t IOConnectMapMemory(io_connect_t connect, unsigned int	memoryType,task_port_t intoTask,
		vm_address_t *atAddress, vm_size_t *ofSize,IOOptionBits options ) { return((kern_return_t)0); }
	kern_return_t IOConnectMethodScalarIScalarO(io_connect_t connect, unsigned int index,
...
/* ========================================================================== */
IcaReturnCode IcaAdrsGet(PciBoard board, unsigned int type, Ulong **adrs, int *taille) {
	return(0);
}
/* ========================================================================== */
...
/* ========================================================================== */
unsigned int IcaFifoRead(PciBoard board) {
	return(0);
}
/* ========================================================================== */
...
/* ACCES PCI STANDARD
   ..................
	...
	Parametrage de IOConnectMethod<type-input>I<type-output>O :
		...
		unsigned int   index    : an index to the function in the Kernel
		<type>=Scalar:
...
IcaReturnCode IcaAdrsGet(PciBoard board, unsigned int type, Ulong **adrs, int *taille) {
    return(IOConnectMapMemory(*board,type,mach_task_self(),
		(vm_address_t *)adrs,(unsigned int *)taille,kIOMapAnywhere));
}
/* ========================================================================== */
void IcaUtilWrite(PciBoard board, Ulong valeur) {
...
/* .......................................................................... */
static void ByteSwappeInt(unsigned int *tab) {
	IntSwappable tempo;
...
/* ========================================================================== */
IcaReturnCode IcaCommandSend(PciBoard board, unsigned char adrs, unsigned char action, unsigned char ss_adrs, unsigned short valeur) {
...
/* ========================================================================== */
int IcaFifoEmpty(PciBoard board, int nb_a_verifier) {
	int num_non_nul; unsigned short val;
...
/* ========================================================================== */
unsigned int IcaFifoRead(PciBoard board) { return(*(board->PCIadrs)); }
/* ========================================================================== */
IcaReturnCode IcaXferInit(PciBoard board, char avec_dma) {
#ifdef macintosh
#ifndef CARBON
