...
14.04.20  9.44  trigger multivoies: modes OU et ET [veto]. Configs de detecteurs. Multiples simus [231 releases].
10.06.20  9.45  Coupure inversee (=rejet). Simu modulation. Gestion decalage template.
...
/*
 ...
 tables inverses:
 (a) TableBolo[position:=unsigned char] -> index du bolo
 (b) TableCablage[connecteur:=unsigned char] -> position
 si reperage connecteur != {1..255}, coder quand meme un unsigned char avec...
