...
static int DiagIcaWriteReg();
static int DiagIcaReadFifo();
static int DiagCcReset();
static int DiagCcStatus();
static int DiagCcRead();
...
/* Initialisation generale */
	...
	MenuItemAdd(mDiag,"Quitter",MNU_RETOUR);
	OpiumPosition(mDiag->cdr,300,50);
	OpiumPosition(pDiag->cdr,100,50);
}
/* ========================================================================== */
int DiagSetup() { return(1); }
/* ========================================================================== */
int DiagSauve() { PasImplementee(); return(0); }
/* ========================================================================== */
int DiagExit() {
