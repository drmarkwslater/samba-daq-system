...
/* ======================================================================= */
void LogInit()  { LogStd = 1; LogTerm = 0; LogFile = 0; LogMbx = -1; }
/* ======================================================================= */
...
/* ======================================================================== */
void LogBlocBegin() { if(LogTerm) TermHold(LogTerm); }
/* ======================================================================== */
void LogBlocEnd() { if(LogTerm) TermRelease(LogTerm); }
/* ======================================================================== */
#endif
#ifdef LOG_ON_SERVER
/* ======================================================================= */
