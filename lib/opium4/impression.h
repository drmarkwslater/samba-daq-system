...
#ifdef IMPRIME_C
 = { "texte", "postscript", "PDF", "html", "http", "\0" }
#endif
;
...
int  ImpressionLargeurCourante();
int  ImpressionHauteurCourante();
int  ImpressionLigneCourante();
...
void ImpressionFerme();
void ImpressionFin(char avec_opium);
char *ImpressionFichierCree();
char *ImpressionLog();
