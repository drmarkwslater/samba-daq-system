...
HTML_VAR char HttpPageRecue[HTMLPAGEMAX];
...
HTML_VAR char HttpReponse[HTMLPAGEMAX];
HTML_VAR int  HttpRepDim;
HTML_VAR char HttpPageTotale[HTMLHDRMAX+HTMLPAGEMAX];
HTML_VAR int  HttpPageDim;
